...
\medskip
\coqstart
The sets $\Sequence_{\ge n}(\fullset)$ and
...
an example $\Sequence_{n}(D)$ is implemented as follows {\small
  \inputsnippets{erel3/all_notation.tex,seq1/Sn.tex}}
\coqend
...
{\small \inputsnippets{erel3/Lift_lemma2.tex}}\coqend
...
{\small \inputsnippets{paper_csbr/L7_csbrn.tex}} \coqend.
