...
and thus can be used also to Lift a sequence of edges (in $\fullset\times\fullset$) into
...
It is to be noted that the deplayment in paths may be obtained as the image by the Lift mapping of a
