...
definitions recalled at the beginning of this section.\end{leftbar}
...
\begin{leftbar} The lift operation, when restricted to the subset \texttt{D} defined below,
is bijective onto its image \texttt{I}
{\small \inputsnippets{seq1/DI-n.tex,seq1/Lift_inj-n.tex,seq1/Lift_surj-n.tex}}
Moreover, the inverse of \texttt{Lift} is explicitely obtained by a recursive mapping \texttt{UnLift} (not detailed here). \end{leftbar}
...
\begin{leftbar} The Coq formalization of the binary relation \(\ActiveTr\) easily follows 
...
is defined in Coq by \texttt{Fset}. \end{leftbar}
\medskip
...
{\small \inputsnippets{seq1/D_U_a1-n.tex}} \end{leftbar}
