...
\texttt{classical\_sets.v} from the mathcomp library~\cite{MathComp:2022}
...
definitions recalled at the begining of the section.
...
\texttt{Lift}: {\small \inputsnippets{erel3/Lift.tex} }

The list operator will be usefull to convert node paths into edge paths and
...
\paragraph{(Coq)} 
{\small \inputsnippets{erel3/EPath2new.tex,erel3/EPath3new,erel3/EPath2inter}}
