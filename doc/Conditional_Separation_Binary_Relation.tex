...
\coqstart {\small \inputsnippets{erel3/Eope.tex}} \coqend
...
\coqstart The Coq formalization easily follows 
...
write with \texttt{ChrelO} and the forward set defined by Equation~\eqref{eq:TransitiveReflexiveClosure_AgentSubsetW} 
is defined by \texttt{Fset}. \coqend

\coqstart The Coq formalization easily follows \coqend
