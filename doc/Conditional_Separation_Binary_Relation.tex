...
\paragraph{$\bullet$ \texttt{Lift} bijection.} The lift operation, when restricted to the subset \texttt{D} defined below,
is bijective onto its image \texttt{I}
{\small \inputsnippets{seq1/DI-n.tex,seq1/Lift_inj-n.tex,seq1/Lift_surj-n.tex}}
The inverse of \texttt{Lift} is obtained with the recursive mapping \texttt{UnLift} (not detailed here). 
...
\paragraph{ZZZZZ parler de U construit comme image avec LiftO}
\coqstart The coq formalization of \undirectedEdgePaths\ paths of size greater or equal to
...
\paragraph{$\bullet$ endpoints} ZZZZZ
