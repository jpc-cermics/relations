...
Using the relation $C_{\textsc{H}}$ -- denote \texttt{Chrel} in Coq -- on the product set $T{\times}T$  defined by
...
Lemma \texttt{Lift\_lemma} which gives us the possibility to treat the set ZZZZZZ
{\small \inputsnippets{erel3/Lift_lemma.tex,erel3/Lift_lemma1.tex, erel3/Lift_lemma2.tex,} 
